...
| `ConversationalAIAPI` | Main API for handlers, subscription, chat, interrupt, audio settings, and destroy |
| `ConversationalAIAPIEventHandler` | Main callback interface for state, transcripts, errors, metrics, receipts, and debug logs |
